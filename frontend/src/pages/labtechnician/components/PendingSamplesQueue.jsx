...
export default function PendingSamplesQueue({ samples = [], selectedSampleId, onSelectSample }) {
      ...
      <div className="space-y-2">
        {sampleList.map((sample, idx) => (
          <div
            ...
            className={`p-2 px-3 rounded border text-[10px] cursor-pointer transition-all ${
